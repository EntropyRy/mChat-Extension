...
$lang = array_merge($lang, array(
    ...
    'MCHAT_SIMPLE_MSG'                      => 'Use even more simple message format',
    'MCHAT_SIMPLE_MSG_EXPLAIN'              => 'Make the messages really simple. No avatars, time or any buttons',
    'MCHAT_ON_VIEWFORUM'		        	=> 'mChat On Viewforum',
	'MCHAT_ON_VIEWFORUM_EXPLAIN'        	=> 'Allow the display of the mChat on the viewforum page. Keep in mind that this effects heavily on server load.',
    'MCHAT_ON_VIEWTOPIC'        			=> 'mChat On Viewtopic',
	'MCHAT_ON_VIEWTOPIC_EXPLAIN'        	=> 'Allow the display of the mChat on the viewtopic page. Keep in mind that this effects heavily on server load.',
	...
	'MCHAT_LOCATION_EXPLAIN'				=> 'Choose the location of the mChat on the page.',
	'MCHAT_TOP_OF_FORUM'					=> 'Top of Forum',
	'MCHAT_BOTTOM_OF_FORUM'					=> 'Bottom of Forum',
	'MCHAT_RIGHT_OF_FORUM'					=> 'Right of Forum',
	...
	'MCHAT_MESSAGE_TOP'			        	=> 'Keep message and inputbox on Bottom / Top',
	'MCHAT_MESSAGE_TOP_EXPLAIN'	        	=> 'This will post the message bottom or top in the chat message area and moves the inputbox accordingly for intuitive use.',
	'MCHAT_BOTTOM'							=> 'Bottom',
	'MCHAT_TOP'								=> 'Top',
