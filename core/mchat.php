	...
	*/
	protected function render_page($page)
	{
		...
		$this->template->assign_vars(array(
			...
			'L_MCHAT_COPYRIGHT'				=> base64_decode(''), 
	...
	*/
	protected function assign_global_template_data()
	{
		$this->template->assign_vars(array(
			...
			'MCHAT_SIMPLE_MSG'		        => $this->config['mchat_simple_msg'],
