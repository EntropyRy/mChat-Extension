...
class install_mchat extends \phpbb\db\migration\migration
{
	...
	public function update_data()
	{
		return array(
			// Add configs
			array('config.add', array('mchat_on_viewtopic', 0)),
			array('config.add', array('mchat_on_viewforum', 0)),
			array('config.add', array('mchat_simple_msg', 0)),
		...
		return array(
			...
			'add_columns'	=> array(
				$this->table_prefix . 'users' => array(
					...
					'user_mchat_follow'             => array('BOOL', '1'),
					'user_mchat_capitalization'     => array('BOOL', '1'),
